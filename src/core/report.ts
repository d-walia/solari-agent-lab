...
<style>
  :root{--ground:#f4f6f8;--surface:#fff;--surface2:#eef0f3;--ink:#15181c;--soft:#4a4e55;--muted:#767c85;--border:#e0e4ea;--accent:${accent};}
  @media(prefers-color-scheme:dark){:root{--ground:#0e1013;--surface:#15181c;--surface2:#1c2025;--ink:#eceef1;--soft:#b3b8bf;--muted:#828892;--border:#262b31;}}
...
export async function writeReport(
  path: string,
  opts: { title: string; subtitle: string; accent?: string; kpis: string[]; rows: string[] },
): Promise<void> {
  const body =
